...
@section('page-script')
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            setTimeout(() => {
                ...
                if (document.getElementById('invoiceSelect')) {
                    ...
                    invoiceSelect.value = "{{ $debitNote->invoice_id }}";
                ...
                if (document.getElementById('tax')) {
                    document.getElementById('tax').value = "{{ $debitNote->document_tax_id ?? 0 }}";
                }
                
                // Set document-level discount
                document.getElementById('discount-type').value = "{{ $debitNote->document_discount_type == 1 ? '%' : 'Amount' }}";
                document.getElementById('discount').value = "{{ $debitNote->document_discount_rate > 0 ? $debitNote->document_discount_rate : $debitNote->document_discount_amount }}";
        ...
        // Calculate grand totals for the entire debit note
        ...
        // Function to handle form submission for updating the debit note
        function updateDebitNote() {
            ...
            let formData = new FormData(document.getElementById('debitNoteForm'));
            ...
            .then(data => {
                Swal.fire({ 
                    icon: 'success', 
                    title: 'Success!', 
                    text: data.message || "Debit note updated successfully.",
                    confirmButtonColor: '#3085d6',
                })
                .then(() => {
            ...
            .catch(error => {
                ...
                Swal.fire({ 
                    icon: 'error', 
                    title: 'Error!', 
                    text: error.message || 'An error occurred while updating the debit note.',
                    confirmButtonColor: '#3085d6',
                });
            })
            .finally(() => {
        ...
        <div class="col-lg-9 col-12 mb-lg-0 mb-6">
            <div class="card invoice-preview-card p-sm-12 p-6">
                    ...
                    <div class="d-flex flex-wrap flex-column flex-sm-row justify-content-between text-heading">
                        ...
                        <div class="col-md-5 col-8 pe-0 ps-0 ps-md-2">
                            <dl class="row mb-0 gx-4">
                                ...
                                <dd class="col-sm-7">
                                    <input type="text" class="form-control" disabled value="{{ $debitNoteNumber }}"
                                        id="debitNoteId" />
                                </dd>
                ...
                <div class="card-body pt-0 px-0">
                    <form class="source-item" id="debitNoteForm">
                        @csrf
                                    ...
                                    <div class="repeater-wrapper pt-0 pt-md-9" data-repeater-item>
                                        <div class="d-flex border rounded position-relative pe-0">
                                            <div class="row w-100 p-6 g-6">
                                                ...
                                                <input type="hidden" name="tax_id" value="{{ $debitNoteItem->tax_id ?? 0 }}" />
                                                ...
                                                <div class="col-md-2 col-12 mb-md-0 mb-4">
                                                    ...
                                                    <input type="number"
                                                        ...
                                                        placeholder="999" value="{{ number_format($debitNoteItem->selling_unit_price, 2, '.', '') }}" step="0.01"
                                                        min="0">
                                                    <div class="text-heading mt-2">
                                                        <div class="mb-1"><small class="text-muted">Discount:</small>
                                                            <span class="discount me-2">{{ $debitNoteItem->discount_rate ?? 0 }}%</span>
                                                        ...
                                                        <div class="mb-1"><small class="text-muted">Tax:</small>
                                                            <span class="tax-1 me-2">
                                                                @if($debitNoteItem->tax_id)
                                                                    {{ optional($debitNoteItem->tax)->name }} ({{ optional($debitNoteItem->tax)->percentage }}%)
                                                                @else
                                                                    0%
                                                                @endif
                                                            </span>
                                                ...
                                                <div class="col-md-2 col-12 mb-md-0 mb-4">
                                                    ...
                                                    <input type="number" class="form-control quantity" name="quantity"
                                                        placeholder="1" value="{{ $debitNoteItem->quantity }}"
                                                        min="1">
                                                </div>
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end w-px-300 p-4">
                                                        <div class="row g-3">
                                                            ...
                                                            <div class="col-12"><label
                                                                    ...
                                                                    <option value="0" {{ is_null($debitNoteItem->tax_id) || $debitNoteItem->tax_id == 0 ? 'selected' : '' }}>No Tax (0%)</option>
                                                                    @foreach ($taxes as $tax)
                                                                        <option value="{{ $tax->id }}" {{ $debitNoteItem->tax_id == $tax->id ? 'selected' : '' }}>
            ...
            <div class="card mb-6">
                <div class="card-body">
                    <button class="btn btn-primary d-grid w-100 mb-4" data-bs-toggle="offcanvas" data-bs-target="#sendInvoiceOffcanvas">
                        <span class="d-flex align-items-center justify-content-center text-nowrap"><i class="icon-base bx bx-paper-plane icon-xs me-2"></i>Send Debit Note</span>
                    </button>
