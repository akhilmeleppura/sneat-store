...
@section('page-script')
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
                ...
                if (debitNoteForm.length) {
                    debitNoteForm.repeater({
                        ...
                        show: function() {
                            ...
                            // Initialize Select2 on the new item's dropdown
                        ...
                        hide: function(deleteElement) {
                            // This function is called when an item is deleted
                            const $item = $(this);
                            const itemSelect = $item.find('.item-details');

                            // Properly destroy the Select2 instance before removing the element
                            if (itemSelect.hasClass('select2-hidden-accessible')) {
                                itemSelect.select2('destroy');
                            }

                            // Confirm deletion and then remove the element
            ...
            // =========================================================================================
            // APPLY CHANGES EVENT LISTENER (FROM INVOICE BLADE)
            // =========================================================================================
            ...
            fetch("{{ route('billing.debit-notes.store') }}", {
                ...
                .catch(error => {
                    ...
                    Swal.fire({
                        icon: 'error',
                        title: 'Error!',
                        html: `<div>An error occurred while saving the debit note.</div><div class="text-muted small mt-2">${error.message}</div>`,
                        confirmButtonColor: '#3085d6',
                    });
                });
        }
                ...
                <div class="card-body px-0">
                    <div class="row">
                        <div class="col-md-6 col-sm-5 col-12 mb-sm-0 mb-6">
                            <h6>Invoice To:</h6>
                            {{-- Changed id to invoiceSelect and name to invoice_id_select for consistency --}}
                                    ...
                                    <div class="d-flex border rounded position-relative pe-0">
                                        <div class="row w-100 p-6 g-6">
                                            <div class="col-md-4 col-12 mb-md-0 mb-4">
                                                ...
                                                {{-- The new JS will target this class to initialize Select2 --}}
                                                    ...
                                                    <div class="row g-3">
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <select name="tax-1-input"
                                                                ...
                                                                <option value="0" data-percentage="0" selected>
                                                                    0%
                                                                </option>
                                                                @if (count($taxes) > 0)
