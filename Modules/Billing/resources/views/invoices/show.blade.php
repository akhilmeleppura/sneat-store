            ...
            <div class="card invoice-preview-card p-sm-12 p-6">
                ...
                <div class="card-body invoice-preview-header rounded">
                    <div
                        ...
                        {{-- Invoice info --}}
                        <div>
                            <h5 class="mb-6">Invoice #{{ $invoice->document_prefix }}-{{ $invoice->document_number }}
                            </h5>
                        ...
                        <tbody>
                            @forelse ($invoice->items as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->description ?? ($item->billingItem->description ?? ($item->item->description ?? 'N/A')) }}
                                    </td>
                                    <td>{{ $item->quantity }}</td>
                                    ...
                                    {{-- Total line --}}
                                    <td>${{ number_format($item->total_price ?? $item->quantity * $item->selling_unit_price, 2) }}
                                    </td>
                                </tr>
                            @empty
                                <tr>
