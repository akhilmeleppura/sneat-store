        ...
        <div class="col-lg-9 col-12 mb-lg-0 mb-6">
            <div class="card invoice-preview-card p-sm-12 p-6">
                ...
                <div class="card-body px-0">
                    <div class="row">
                        <div class="col-md-6 col-sm-5 col-12 mb-sm-0 mb-6">
                            <h6>Invoice To:</h6>
                            <select class="form-select mb-4 w-75" id="clientSelect">
                                <option value="">-- Select Customer --</option>
                                @foreach ($clients as $client)
                                    <option value="{{ $client->id }}" data-company="{{ $client->company_name ?? '' }}"
                                        data-address="{{ $client->address ?? '' }}" data-city="{{ $client->city ?? '' }}"
                ...
                <div class="card-body pt-0 px-0">
                    <form class="source-item" id="invoiceForm">
                        @csrf
                                            ...
                                            <div class="row w-100 p-6 g-6">
                                                ...
                                                <div class="col-md-2 col-12 mb-md-0 mb-4">
                                                    ...
                                                    <input type="number" class="form-control quantity" name="quantity"
                                                        placeholder="1" value="{{ $invoiceItem->quantity }}"
                                                        min="1">
                                                </div>
                                        ...
                                        <select id="tax" class="form-select form-control-sm me-2"
                                            ...
                                            @foreach ($taxes as $tax)
                                                <option value="{{ $tax->id }}" data-rate="{{ $tax->percentage }}"
                                                    {{ $invoice->document_tax_id == $tax->id ? 'selected' : '' }}>
