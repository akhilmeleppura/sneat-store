...
@section('page-script')
    ...
    <script>
        ...
        function updateCreditNote() {
            ...
            // Validate issue date
            const issueDate = document.querySelector('.credit-note-date').value;
            if (!issueDate) {
                return Swal.fire({
                    icon: 'warning',
                    title: 'Validation Error',
                                                ...
                                                <div class="col-md-2 col-12 mb-md-0 mb-4">
                                                    ...
                                                    <div class="text-heading mt-2">
                                                        <div class="mb-1"><small class="text-muted">Discount:</small>
                                                            <span
                                                                class="discount me-2">{{ $creditNoteItem->discount_rate ?? 0 }}%</span>
                                                        ...
                                                        <div class="mb-1"><small class="text-muted">Tax:</small>
                                                            <span class="tax-1 me-2">
                                                                @if ($creditNoteItem->tax_id)
                                                                    {{ optional($creditNoteItem->tax)->name }}
                                                                    ({{ optional($creditNoteItem->tax)->percentage }}%)
                                                                @else
                                                                    0%
                                                                @endif
                                                            </span>
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end w-px-300 p-4">
                                                        <div class="row g-3">
                                                            ...
                                                            <div class="col-12"><label
                                                                    ...
                                                                    <option value="0"
                                                                        {{ is_null($creditNoteItem->tax_id) || $creditNoteItem->tax_id == 0 ? 'selected' : '' }}>
                                                                        No Tax (0%)</option>
