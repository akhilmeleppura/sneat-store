...
<div class="col-12">
  <div class="card">
    ...
    <div class="card-body">
      <form action="{{ route('accounting.journal.store') }}" method="POST" id="journal-form">
        @csrf
        ...
        <div id="journal-entries">
          <div class="row journal-entry align-items-center mb-2">
            <div class="col-md-3">
              <select name="entries[0][ledger_account_id]" class="form-control form-control-sm" required>
            ...
            <div class="col-md-2">
              <input type="number" name="entries[0][debit_amount]" class="form-control form-control-sm debit-amount" placeholder="0.00">
            </div>
            <div class="col-md-2">
              <input type="number" name="entries[0][credit_amount]" class="form-control form-control-sm credit-amount" placeholder="0.00">
            </div>
            <div class="col-md-3">
              <input type="text" name="entries[0][description]" class="form-control form-control-sm" placeholder="Description">
            </div>
        ...
        <div class="row align-items-center">
          <div class="col-md-6">
            ...
            <input type="text" name="summary" id="summary" class="form-control" placeholder="General remarks...">
          </div>
          <div class="col-md-3">
