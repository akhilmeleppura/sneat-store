    ...
    <div class="tab-content p-0">
      <div class="tab-pane fade show active" id="chart_of_accounts" role="tabpanel">
        ...
        <div class="card mb-4">
          ...
          <div class="card-body">
            <p class="text-muted mb-0">Use the button above to add a new category with main type and description.</p>
          </div>
        </div>
        ...
        <div class="modal fade" id="addCategoryModal" tabindex="-1" aria-labelledby="addCategoryModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <form method="POST" action="{{ route('accounting.subcategory.store') }}">
              @csrf
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div class="mb-3">
                    ...
                    <select name="main_category_id" id="main_category_id" class="form-select select2" required>
