        ...
        <div class="container px-0">
          <div class="card shadow rounded">
            ...
            <div class="card-body">
              ...
              <form action="{{ route('accounting.prefix.store') }}" method="POST">
                @csrf

                <div class="mb-3">
                    <label for="journal_name" class="form-label">Journal Name</label>
                    <input type="text" name="journal_name" id="journal_name" class="form-control" placeholder="Enter journal name" required>
                </div>
