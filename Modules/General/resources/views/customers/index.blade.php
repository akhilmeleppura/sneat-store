...
@section('content')
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasAddCustomer" aria-labelledby="offcanvasAddCustomerLabel">
    ...
    <div class="offcanvas-body mx-0 flex-grow-0 p-6 h-100">
      <form class="add-new-customer pt-0" id="addNewCustomerForm" action="{{ route('customers.store') }}" method="POST">
        @csrf
        <div class="mb-6 form-control-validation">
          <label class="form-label" for="add-customer-name">Name</label>
          <input type="text" class="form-control" id="add-customer-name" placeholder="John Doe" name="name"
            aria-label="John Doe" required />
        </div>
        <div class="mb-6 form-control-validation">
          <label class="form-label" for="add-customer-email">Email</label>
          <input type="email" id="add-customer-email" class="form-control" placeholder="john.doe@example.com"
            aria-label="john.doe@example.com" name="email" required />
        </div>
        <div class="mb-6">
          <label class="form-label" for="add-customer-phone">Phone</label>
          <input type="text" id="add-customer-phone" class="form-control phone-mask" placeholder="+1 (609) 988-44-11"
            aria-label="+1 (609) 988-44-11" name="phone" />
        </div>
        <div class="mb-6">
