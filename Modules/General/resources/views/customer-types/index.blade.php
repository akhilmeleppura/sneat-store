                  ...
                  <td>
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu">
                        <a class="dropdown-item" href="{{ route('customer-types.show', $type->id) }}">
                          <i class="bx bx-show me-1"></i> View
                        </a>
                        <a class="dropdown-item" href="{{ route('customer-types.edit', $type->id) }}">
                          <i class="bx bx-edit-alt me-1"></i> Edit
                        </a>
                        <form action="{{ route('customer-types.destroy', $type->id) }}" method="POST" class="delete-customer-type-form">
                          @csrf
                          @method('DELETE')
