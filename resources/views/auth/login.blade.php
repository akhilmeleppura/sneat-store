...
@section('title', 'Sign In — Enterprise Commerce')
    ...
    <div class="d-flex col-12 col-lg-5 col-xl-5 align-items-center justify-content-center p-sm-5 p-4 auth-form-container position-relative">
      <div class="w-100" style="max-width: 440px;">
        ...
        <div class="mb-4 p-3 rounded-3" style="background: rgba(255, 255, 255, 0.03); border: 1px solid rgba(255, 255, 255, 0.08);">
          ...
          <div class="row g-2">
            <div class="col-4">
              <div class="demo-role-card" id="role-admin-main" onclick="selectDemoRole('admin@sneat.test', 'password', 'role-admin-main')">
            ...
            <div class="col-4">
              <div class="demo-role-card" id="role-vendor-main" onclick="selectDemoRole('vendor@sneat.test', 'password', 'role-vendor-main')">
            ...
            <div class="col-4">
              <div class="demo-role-card" id="role-customer-main" onclick="selectDemoRole('customer@sneat.test', 'password', 'role-customer-main')">
...
document.addEventListener('DOMContentLoaded', () => {
  const adminBtn = document.getElementById('role-admin-main');
